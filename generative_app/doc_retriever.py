...
def load_streamlit_docs() -> VectorStoreRetriever:
    ...
    # load from disk
    retriever = Chroma(persist_directory=".doc_db/streamlit_chroma_db").as_retriever()
...
if __name__ == "__main__":
    ...
    vectorstore = Chroma.from_documents(documents=streamlit_source_code_doc,embedding=embeddings_model, persist_directory=f".doc_db/streamlit_chroma_db")
    vectorstore.persist()
